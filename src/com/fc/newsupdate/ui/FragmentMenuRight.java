...
import com.fc.newsupdate.common.LoadImage;
import com.fc.newsupdate.common.LoadImage.ImageLoadListener;
import com.fc.newsupdate.common.LogUtil;
import com.fc.newsupdate.common.SharedPreferencesUtils;
import com.fc.newsupdate.common.SystemUtils;
import com.fc.newsupdate.model.biz.UpdateManager;
import com.fc.newsupdate.model.biz.parser.ParserVersion;
import com.fc.newsupdate.model.enity.Version;
import com.fc.newsupdate.model.httpclient.TextHttpResponseHandler;
import com.fc.newsupdate.onkeyshare.OnekeyShare;
import com.fc.newsupdate.receiver.DownloadCompleteReceiver;
			...
			public void onClick(View view) {
				UpdateManager.judgeUpdate(new TextHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						//判断本地版本与服务器版本
						if(CommonUtil.getVersionCode(FragmentMenuRight.this.getActivity())
